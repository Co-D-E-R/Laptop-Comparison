...
const Compare: React.FC = () => {
  ...
  const specCategories = {
    basic: comparisonSpecs.filter((spec) => spec.category === "basic"),
    performance: comparisonSpecs.filter(
      (spec) => spec.category === "performance"
    ),
    display: comparisonSpecs.filter((spec) => spec.category === "display"),
    connectivity: comparisonSpecs.filter(
      (spec) => spec.category === "connectivity"
    ),
    physical: comparisonSpecs.filter((spec) => spec.category === "physical"),
    price: comparisonSpecs.filter((spec) => spec.category === "price"),
    rating: comparisonSpecs.filter((spec) => spec.category === "rating"),
  };
      ...
      <div className="pt-24 px-6">
        <div className="container mx-auto">
          ...
          <div className="mt-8 space-y-6">
            {comparedLaptops.map((laptop) => {
              const features = laptop.specs?.details?.Features;
