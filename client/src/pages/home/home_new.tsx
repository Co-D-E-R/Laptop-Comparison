...
export default function Home() {
  ...
  // Use history products for recently viewed if user is logged in
  const displayRecentlyViewed = user && historyProducts.length > 0 ? historyProducts : [];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1a1333] via-[#2d1b4d] to-[#1a2a4f] text-white relative overflow-hidden">
      ...
      <main className="flex-1 space-y-16 pb-16">
        ...
        />
        <RecentlyViewed products={displayRecentlyViewed} />
